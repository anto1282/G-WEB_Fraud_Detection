...
def test_data_loading(dataset):
    # Check that data loads and is not empty
...
def test_random_node_split(dataset):
    # Check if RandomNodeSplit works
...
def test_data_device_transfer(dataset):
    # Check if data can be transferred to GPU (if available)
